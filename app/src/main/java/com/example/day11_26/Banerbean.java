...
public class Banerbean {
    ...
    public static class DataBean {
         ...
         * type : 0
         * url : https://mp.weixin.qq.com/s/S2IEg2QT6IBBeqKLJSwpCg
         */
